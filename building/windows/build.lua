...
cflags = "-c -std=c11 -Wall -DSPNG_USE_MINIZ -std=c11 -Iftinclude -DGLEW_STATIC -Dmain=SDL_main -DSPNG_STATIC -D_POSIX_C_SOURCE=199309L -Iinclude/AL -Iinclude  -Iinclude/SDL2 -Iinclude/GL -march=x86-64-v3 -mavx2 -m64 -mfpmath=sse -msse2 -flto -O2 "
...
flags = "-flto -O2 -lm -lpthread -mwindows -lopengl32 -lopenal -lmingw32 -lSDL2main -lSDL2 -mwindows -Wl,--dynamicbase -Wl,--nxcompat -Wl,--high-entropy-va -lm -ldinput8 -ldxguid -ldxerr8 -luser32 -lgdi32 -lwinmm -limm32 -lole32 -loleaut32 -lshell32 -lsetupapi -lversion -luuid -pthread" -- flags
--flags = "-lSDL2 -lGL -lm -L./bin/lib64 -Wl,-rpath=./bin/lib64 -l:libopenal.so.1.21.1 -lpthread -std=c11 -static-libgcc -static-libstdc++ " -- flags
...
function genMakeFile()
  ...
  makefile[8] = "\t$(CC)  " .. sumfiles .." libfreetype.a $(LFLAGS)" .. " -o tachyonfire"
  makefile[9] = ""
  last = 10
  --generate targets
  for i=1, files.length do
